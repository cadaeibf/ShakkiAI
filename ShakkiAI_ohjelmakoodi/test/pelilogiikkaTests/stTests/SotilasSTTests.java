...
public class SotilasSTTests {
    ...
    public void tavallinenSiirto1() {
        assertTrue(sotilasSt.tarkista(kentta, 1, 1, 0, 2, 0));
    }
    
    @Test
    public void tavallinenSiirto2() {
        assertTrue(sotilasSt.tarkista(kentta, 1, 6, 0, 5, 0));
    }
    
    @Test
    public void aloitusSiirto1() {
        assertTrue(sotilasSt.tarkista(kentta, 1, 1, 0, 3, 0));
    }
    
    @Test
    public void aloitusSiirto2() {
        assertTrue(sotilasSt.tarkista(kentta, 2, 6, 0, 4, 0));
    }
    
    @Test
    public void syomisSiirto1() {
        kentta.haeRuutu(5, 3).setNappula(new Sotilas(new Ihmispelaaja(1)));
        assertTrue(sotilasSt.tarkista(kentta, 1, 5, 3, 6, 4));
    ...
    public void syomisSiirto2() {
        kentta.haeRuutu(5, 3).setNappula(new Sotilas(new Ihmispelaaja(1)));
        assertTrue(sotilasSt.tarkista(kentta, 2, 6, 4, 5, 3));
        
    }
    
    @Test
    public void eiSyodaOmia() {
        kentta.haeRuutu(3, 2).setNappula(new Sotilas(new Ihmispelaaja(1)));
        assertFalse(sotilasSt.tarkista(kentta, 1, 1, 2, 2, 3));
    }
    
    @Test
    public void sotilasEiPeraanny() {
        kentta.haeRuutu(4, 4).setNappula(new Sotilas(new Ihmispelaaja(1)));
        assertFalse(sotilasSt.tarkista(kentta, 1, 4, 4, 3, 4));
    }
