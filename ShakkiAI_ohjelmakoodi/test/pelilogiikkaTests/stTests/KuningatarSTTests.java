...
public class KuningatarSTTests {
    ...
    public void laillinenSiirto1() {
        ...
        assertTrue(kuningatarSt.tarkista(kentta, 3, 3, 2, 2));
    }
    ...
    public void laillinenSiirto2() {
        ...
        assertTrue(kuningatarSt.tarkista(kentta, 3, 3, 3, 5));
    }
    ...
    public void laillinenSiirto3() {
        ...
        assertTrue(kuningatarSt.tarkista(kentta, 3, 3, 4, 4));
    }
    ...
    public void laillinenSiirto4() {
        ...
        assertTrue(kuningatarSt.tarkista(kentta, 3, 3, 2, 3));
    }
    
    @Test
    public void kuningatarEiHypiOmienYli() {
        assertFalse(kuningatarSt.tarkista(kentta, 0, 4, 2, 4));
    }
    
    @Test
    public void kuningatarEiSyoOmia() {
        assertFalse(kuningatarSt.tarkista(kentta, 0, 4, 1, 4));
    }
    ...
    public void kuningatarEiHypiVihollistenYli() {
        ...
        assertFalse(kuningatarSt.tarkista(kentta, 3, 3, 7, 7));
    }
    ...
    public void laillinenSyonti() {
        ...
        assertTrue(kuningatarSt.tarkista(kentta, 3, 3, 6, 3));
    }
