...
public class LahettiSTTests {
    ...
    public void setUp() {
        ...
        kentta = new Kentta(pelaaja1, new Pelaaja(2));
    ...
    public void laillinenSiirto1() {
        ...
        assertTrue(lahettiSt.tarkista(kentta, 3, 3, 2, 2));
    }
    ...
    public void laillinenSiirto2() {
        ...
        assertTrue(lahettiSt.tarkista(kentta, 3, 3, 2, 4));
    }
    ...
    public void laillinenSiirto3() {
        ...
        assertTrue(lahettiSt.tarkista(kentta, 3, 3, 4, 4));
    }
    ...
    public void laillinenSiirto4() {
        ...
        assertTrue(lahettiSt.tarkista(kentta, 3, 3, 4, 2));
    }
    ...
    public void laillinenSiirto5() {
        ...
        assertTrue(lahettiSt.tarkista(kentta, 3, 3, 5, 5));
    }
    ...
    public void epaKelvotKoordinaatit1() {
        ...
        assertFalse(lahettiSt.tarkista(kentta, 3, 3, 4, 5));
    }
    
    @Test
    public void lahettiEiHypiOmienYli() {
        assertFalse(lahettiSt.tarkista(kentta, 0, 2, 2, 4));
    }
    
    @Test
    public void lahettiEiMeneOmienPaalle() {
        assertFalse(lahettiSt.tarkista(kentta, 0, 2, 1, 1));
    }
    ...
    public void lahettiEiHypiVihollistenYli() {
        ...
        assertFalse(lahettiSt.tarkista(kentta, 5, 3, 7, 1));
    }
    ...
    public void lahettiSyoVihollisia() {
        ...
        assertTrue(lahettiSt.tarkista(kentta, 5, 3, 6, 2));
    }
}